...
public class JUnitTestMethodGenerator implements CodeGenerator {

    private static final String DISPLAY_NAME = "JUnit @Test method";
     ...
     */
    private JUnitTestMethodGenerator(Lookup context) { // Good practice is not to save Lookup outside ctor
    ...
    private MethodTree makeMethodTree() {
        return make.Method(
                make.Modifiers(
                        ...
                        List.of(make.Annotation(make.Type("org.junit.Test"),
    ...
    @MimeRegistration(mimeType = "text/x-java", service = CodeGenerator.Factory.class, position = 5100)
    public static class Factory implements CodeGenerator.Factory {

        @Override
        public List<? extends CodeGenerator> create(Lookup context) {
            return Collections.singletonList(new JUnitTestMethodGenerator(context));
        }
    }
}
